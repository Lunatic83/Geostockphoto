...
<head>
	...
	<meta name="DESCRIPTION" CONTENT="The new Stock agency for Geotagged Photos.">
	
	<!-- PLUS SEO -->
	<meta name="google-site-verification" content="wzh6Ev6ZVIo5FeaY_ZHgRuNK7i8Nw8Q9ZJ38RWF22-Y" />
	<meta name="omni_page" content="GeoStockPhoto" />
	...
	<body style="min-width: 1370px" onload="<?php if(isset(Yii::app()->controller->onloadFunctions)) echo Yii::app()->controller->onloadFunctions; ?>">
		<?php
		...
		<?php $this->widget('application.components.widgets.Header2', array('idPhotoType'=>$this->idPhotoType, 'user'=>$this->user, 'route'=>$this->route)); ?>
		
		
		<?php if(($this->route!='photo/index')&&
			($this->route!='site/index2')&&
			($this->route!='site/index3')&&
			($this->route!='site/index4')&&
		...
		<div class="<?php echo $class?>" style="min-height:640px">
			<?php echo $content; ?>
		</div>
		
		<?php $this->widget('application.components.widgets.Footer', array('footer_class'=>'footer_index')); ?>
	</body>
</html>