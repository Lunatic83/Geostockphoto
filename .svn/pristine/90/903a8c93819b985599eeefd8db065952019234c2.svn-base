...
abstract class BaseFacebook
{
  ...
  public function api(/* polymorphic */) {
    ...
    if (is_array($args[0])) {
      ...
      return call_user_func_array(array($this, '_graph'), $args); //TODO: vedere se fixare su IIS non funziona
    }
  }
  ...
  //END MODIFICA GASPARE
    ...
    //MODIFICA GASPARE
      ...
      curl_setopt($ch, CURLOPT_CAINFO,
                dirname(__FILE__) . '/fb_ca_chain_bundle_new.crt');
      //curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false); soluzione poco bella disabilità il controllo della CA
  	//END MODIFICA GASPARE
  ...
  protected function getHttpHost() {
    ...
    //MODIFY GASPARE
    return isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : "www.geostockphoto.com";
