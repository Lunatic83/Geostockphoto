...
class jumploader extends CApplicationComponent
{
	...
	public function init()
	{
		...
		$this->defaultAppletOptions['vc_mainViewFileTreeViewVisible'] = false;
		$this->defaultAppletOptions['vc_mainViewFileListViewVisible'] = false;
