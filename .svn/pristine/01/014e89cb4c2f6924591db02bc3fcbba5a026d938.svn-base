...
<div style="margin-top:10px;">
	<?php echo $form->textField($modelUser,'username',array('size'=>32,'maxlength'=>32, 'placeholder'=>'Username')); ?>
	<span class="help-inline " style="margin-bottom: 10px;"><?php echo $form->error($modelUser,'username',array('style'=>'color: red')); ?></span>		
	
	<?php echo $form->passwordField($modelUser,'clearpassword',array('size'=>32, 'placeholder'=>'Password')); ?>
	<span class="help-inline " style="margin-bottom: 10px;"><?php echo $form->error($modelUser,'clearpassword',array('style'=>'color: red')); ?></span>		
	
	<?php echo $form->passwordField($modelUser,'clearpassword_repeat',array('size'=>32, 'placeholder'=>'Repeat Password')); ?>
	...
	<?php echo $form->textField($modelUser,'email',array('size'=>32,'maxlength'=>255, 'placeholder'=>'Email address')); ?>
    <span class="help-inline" style="margin-bottom: 10px;"><?php echo $form->error($modelUser,'email',array('style'=>'color: red')); ?></span>
    
	<?php echo $form->textField($modelUser,'email_repeat',array('size'=>32,'maxlength'=>255, 'placeholder'=>'Repeat Email address')); ?>
	...
	<div style="text-align:center">
		...
		<div>
			Newsletter <?php echo $form->checkBox($modelUser,'mailingList',array('style'=>'margin-top:0px', 'checked'=>'checked')); ?>
		</div>
	</div>
	...
	<div style="text-align:center">
	    ...
	    <div class="captcha"><?php echo CHtml::activeTextField($modelUser,'verifyCodeCaptcha', array('class'=>'captcha', 'placeholder'=>'Write the captcha above')); ?></div>
