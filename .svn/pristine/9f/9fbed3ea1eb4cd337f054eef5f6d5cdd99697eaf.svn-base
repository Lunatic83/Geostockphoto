/*
 * Attualmente questo codice non viene utilizzato perchè
 * si è scelto di usare jqAutocomplete.php
 */
...
(function($) {  
    ...
    $.fn.autoComplete = function(o) {
    	...
    	o = jQuery.extend({
		    ...
		    timeout:0, 				// idle time before hiding the list, set to 0 to disable the timeout
		    ...
		    showMoreResults: true, 	// show a message when more results were found than the maximum
