...
/**
 * This is the model class for table "tbl_conf_shopping_opt_default_gsp".
 *
 * The followings are the available columns in table 'tbl_conf_shopping_opt_default_gsp':
 ...
 */
class ConfShoppingOptDefaultGsp extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_conf_shopping_opt_default_gsp';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('idLicense, idSize', 'length', 'max'=>10),
			array('update_timestamp', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idLicense, idSize, price, insert_timestamp, update_timestamp', 'safe', 'on'=>'search'),
		);
	}
