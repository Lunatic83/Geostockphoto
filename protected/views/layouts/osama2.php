...
<body style="background: white" class="loading" onload="<?php if(isset(Yii::app()->controller->onloadFunctions)) echo Yii::app()->controller->onloadFunctions; ?>">
<?php
...
<div style="margin-left:auto; margin-right:auto; width:420px; margin-top: 50px">
	<?php echo $content; ?>
</div>

<div class="affix bottom left right">
<footer class="footer">
	<div class="footer-btn" id="footer-btn" title="Show Footer">&#9776;</div>
