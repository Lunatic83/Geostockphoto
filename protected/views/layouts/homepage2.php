...
<head>
	...
	<body style="background-image: none; background-color: black" onload="<?php if(isset(Yii::app()->controller->onloadFunctions)) echo Yii::app()->controller->onloadFunctions; ?>">
		<?php
	...
	<?php echo $content; ?>
	<?php $this->widget('application.components.widgets.Footer', array('footer_class'=>'footer', 'margin_top'=>0)); ?>
	</body>
</html>