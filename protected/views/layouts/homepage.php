...
<head>
	...
	<body style="height: 100%; overflow-y: hidden">
		...
		<div style="background:url('<?php echo Yii::app()->request->baseUrl; ?>/images/geostockphoto_id794_by_theos682.jpg') no-repeat;
			background-size:100%;
		...
		<?php //$this->widget('application.components.widgets.Footer'); ?>
	</body>
</html>